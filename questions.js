const myQuestions = [
  ...
  {
    question: "Which of the followings is not a professor from Hogwarts?",
    answers: {
      a: "Severus Snape",
      b: "Gilderoy Lockhart",
      c: "Rouben Meschian",
  ...
  },
  {
    ...
    {
    question: "Which of the followings is not Steven Spielberg movie?",
    answers: {
      a: "Transformers",
      b: "Jaws",
      c: "Jurassic World",
    ...
    {
    question: "Which movie won one big Oscar and seven little ones?",
    answers: {
      a: "Snow White",
      b: "Cinderella",
      c: "Sleeping Beauty",
    ...
    {
    question: "Which one is Walt Disney's last work?",
    answers: {
      a: "The Jungle Book",
      b: "Sleeping Beauty",
      c: "Mary Poppins",
   ...
   {
    question: "Who received Oscar after his death?",
    answers: {
      a: "Paul Walker",
      b: "Robin Williams",
      c: "Heath Ledger",
   ...
   {
    question: "Put in the right order:",
    answers: {
   ...
   {
    question: "What is the only mythological animal mentioned in a Harry Potter book and movie title?",
    answers: {
      a: "Phoenix",
      b: "Dragon",
      c: "Griffin",
   ...
   {
    question: "Which song plays in every Disney movie opening scene?",
    answers: {
      a: "When i wish upon a star from Pinocchio",
      b: "Once upon a dream from Sleeping Beauty",
      c: "A dream is a wish your heart makes from Cinderella",
      d: "I don't know"
    },
    correctAnswer: "a"
  },
   {
    question: "Which movie won the Academy Award in 2017?",
    answers: {
      a: "La La Land",
      b: "Moonlight",
      c: "Arrival",
  ...
  },
 {
  ...
  },
   {
    ...
    answers: {
      ...
      b: "Brad Pitt",
      c: "Tom Cruise",
      d: "Tom and Nicolas(thank god they are not)"
    },
    correctAnswer: "d"
  },
   {
   ...
   {
    question: "Which is the first computer-animated feature film?",
    answers: {
      a: "Casper",
      b: "Toy Story",
      c: "The Flintstones",
  ...
  },
  {
    ...
    answers: {
      ...
      c: "He wanted to help his brother escape",
      d: "He wanted to help his cousin escape"
  },
    correctAnswer: "d"
  },
  {
